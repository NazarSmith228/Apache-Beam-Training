...
public class WordStatistics extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static aggregator.model.WordStatistics.Builder newBuilder() {
    return new aggregator.model.WordStatistics.Builder();
  }
   ...
   * @return A new WordStatistics RecordBuilder
   */
  public static aggregator.model.WordStatistics.Builder newBuilder(aggregator.model.WordStatistics.Builder other) {
    return new aggregator.model.WordStatistics.Builder(other);
  }
   ...
   * @return A new WordStatistics RecordBuilder
   */
  public static aggregator.model.WordStatistics.Builder newBuilder(aggregator.model.WordStatistics other) {
    return new aggregator.model.WordStatistics.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WordStatistics>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(aggregator.model.WordStatistics.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(aggregator.model.WordStatistics other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.wordsFromAToH)) {
        this.wordsFromAToH = data().deepCopy(fields()[0].schema(), other.wordsFromAToH);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.WordStatistics.Builder setWordsFromAToH(java.util.Map<java.lang.String,java.util.List<java.lang.String>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.WordStatistics.Builder clearWordsFromAToH() {
      wordsFromAToH = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.WordStatistics.Builder setWordsFromIToQ(java.util.Map<java.lang.String,java.util.List<java.lang.String>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.WordStatistics.Builder clearWordsFromIToQ() {
      wordsFromIToQ = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.WordStatistics.Builder setWordsFromRToZ(java.util.Map<java.lang.String,java.util.List<java.lang.String>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.WordStatistics.Builder clearWordsFromRToZ() {
      wordsFromRToZ = null;
