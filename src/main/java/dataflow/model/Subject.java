...
public class Subject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4234815136269929101L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Subject\",\"namespace\":\"dataflow.model\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"string\",\"java-class\":\"java.lang.String\"}},{\"name\":\"id\",\"type\":\"int\"}]}");
   ...
   */
  public static dataflow.model.Subject.Builder newBuilder() {
    return new dataflow.model.Subject.Builder();
  }
   ...
   * @return A new Subject RecordBuilder
   */
  public static dataflow.model.Subject.Builder newBuilder(dataflow.model.Subject.Builder other) {
    return new dataflow.model.Subject.Builder(other);
  }
   ...
   * @return A new Subject RecordBuilder
   */
  public static dataflow.model.Subject.Builder newBuilder(dataflow.model.Subject other) {
    return new dataflow.model.Subject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Subject>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(dataflow.model.Subject.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(dataflow.model.Subject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public dataflow.model.Subject.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dataflow.model.Subject.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dataflow.model.Subject.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dataflow.model.Subject.Builder clearId() {
