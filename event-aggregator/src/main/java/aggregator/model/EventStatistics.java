...
public class EventStatistics extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public aggregator.model.Subject eventSubject;
  @Deprecated public java.util.List<aggregator.model.Activity> activities;
   ...
   */
  public EventStatistics(aggregator.model.Subject eventSubject, java.util.List<aggregator.model.Activity> activities) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: eventSubject = (aggregator.model.Subject)value$; break;
    case 1: activities = (java.util.List<aggregator.model.Activity>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public aggregator.model.Subject getEventSubject() {
    return eventSubject;
  }
   ...
   */
  public void setEventSubject(aggregator.model.Subject value) {
   ...
   */
  public java.util.List<aggregator.model.Activity> getActivities() {
    return activities;
  }
   ...
   * @param value the value to set.
   */
  public void setActivities(java.util.List<aggregator.model.Activity> value) {
   ...
   */
  public static aggregator.model.EventStatistics.Builder newBuilder() {
    return new aggregator.model.EventStatistics.Builder();
  }
   ...
   * @return A new EventStatistics RecordBuilder
   */
  public static aggregator.model.EventStatistics.Builder newBuilder(aggregator.model.EventStatistics.Builder other) {
    return new aggregator.model.EventStatistics.Builder(other);
  }
   ...
   * @return A new EventStatistics RecordBuilder
   */
  public static aggregator.model.EventStatistics.Builder newBuilder(aggregator.model.EventStatistics other) {
    return new aggregator.model.EventStatistics.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventStatistics>
    ...
    private aggregator.model.Subject eventSubject;
    private aggregator.model.Subject.Builder eventSubjectBuilder;
    private java.util.List<aggregator.model.Activity> activities;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(aggregator.model.EventStatistics.Builder other) {
      super(other);
      ...
      if (other.hasEventSubjectBuilder()) {
        this.eventSubjectBuilder = aggregator.model.Subject.newBuilder(other.getEventSubjectBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(aggregator.model.EventStatistics other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventSubject)) {
        this.eventSubject = data().deepCopy(fields()[0].schema(), other.eventSubject);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.EventStatistics.Builder setEventSubject(aggregator.model.Subject value) {
     ...
     * @return This builder.
     */
    public aggregator.model.Subject.Builder getEventSubjectBuilder() {
      if (eventSubjectBuilder == null) {
        if (hasEventSubject()) {
          setEventSubjectBuilder(aggregator.model.Subject.newBuilder(eventSubject));
        } else {
          setEventSubjectBuilder(aggregator.model.Subject.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public aggregator.model.EventStatistics.Builder setEventSubjectBuilder(aggregator.model.Subject.Builder value) {
      clearEventSubject();
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.EventStatistics.Builder clearEventSubject() {
      eventSubject = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.EventStatistics.Builder setActivities(java.util.List<aggregator.model.Activity> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aggregator.model.EventStatistics.Builder clearActivities() {
      activities = null;
    ...
    public EventStatistics build() {
      try {
        ...
        if (eventSubjectBuilder != null) {
          ...
          record.eventSubject = fieldSetFlags()[0] ? this.eventSubject : (aggregator.model.Subject) defaultValue(fields()[0]);
        }
        record.activities = fieldSetFlags()[1] ? this.activities : (java.util.List<aggregator.model.Activity>) defaultValue(fields()[1]);
        return record;
