...
import aggregator.options.JobOptions;
import aggregator.transform.ParseEventsPTransform;
import aggregator.transform.dofn.EventDividerFn;
import aggregator.transform.dofn.GroupBySubjectFn;
import aggregator.transform.dofn.StatisticsAggregatorFn;
import aggregator.transform.dofn.StatisticsTransformerFn;
...
public class EventAggregator {
    ...
    private static final String DEBUG_PATH = "event-aggregator/src/main/resources/tmp";
