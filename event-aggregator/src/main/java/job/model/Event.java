...
public class Event extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Event(java.lang.String id, java.lang.String userId, java.lang.String city, java.lang.String eventType, java.lang.Long timestamp, job.model.Subject eventSubject) {
    this.id = id;
    this.userId = userId;
    this.city = city;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: eventSubject = (job.model.Subject)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static job.model.Event.Builder newBuilder() {
    return new job.model.Event.Builder();
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static job.model.Event.Builder newBuilder(job.model.Event.Builder other) {
    return new job.model.Event.Builder(other);
  }
   ...
   * @return A new Event RecordBuilder
   */
  public static job.model.Event.Builder newBuilder(job.model.Event other) {
    return new job.model.Event.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Event>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(job.model.Event.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(job.model.Event other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder setUserId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder setCity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder setEventType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder clearEventType() {
      eventType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder setEventSubject(job.model.Subject value) {
     ...
     * @return This builder.
     */
    public job.model.Event.Builder setEventSubjectBuilder(job.model.Subject.Builder value) {
      clearEventSubject();
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Event.Builder clearEventSubject() {
      eventSubject = null;
    ...
    public Event build() {
      try {
        ...
        if (eventSubjectBuilder != null) {
          ...
          record.eventSubject = fieldSetFlags()[5] ? this.eventSubject : (job.model.Subject) defaultValue(fields()[5]);
        }
        return record;
