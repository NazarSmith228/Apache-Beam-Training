...
public class EventInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7258557160193435916L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventInfo\",\"namespace\":\"job.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"java-class\":\"java.lang.String\"}},{\"name\":\"userId\",\"type\":{\"type\":\"string\",\"java-class\":\"java.lang.String\"}},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"eventType\",\"type\":{\"type\":\"string\",\"java-class\":\"java.lang.String\"}}]}");
   ...
   */
  public static job.model.EventInfo.Builder newBuilder() {
    return new job.model.EventInfo.Builder();
  }
   ...
   * @return A new EventInfo RecordBuilder
   */
  public static job.model.EventInfo.Builder newBuilder(job.model.EventInfo.Builder other) {
    return new job.model.EventInfo.Builder(other);
  }
   ...
   * @return A new EventInfo RecordBuilder
   */
  public static job.model.EventInfo.Builder newBuilder(job.model.EventInfo other) {
    return new job.model.EventInfo.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventInfo>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(job.model.EventInfo.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(job.model.EventInfo other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.EventInfo.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.EventInfo.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.EventInfo.Builder setUserId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.EventInfo.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.EventInfo.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.EventInfo.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.EventInfo.Builder setEventType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.EventInfo.Builder clearEventType() {
      eventType = null;
