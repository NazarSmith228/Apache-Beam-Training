...
public class Activity extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8198380442010160563L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Activity\",\"namespace\":\"job.model\",\"fields\":[{\"name\":\"eventType\",\"type\":{\"type\":\"string\",\"java-class\":\"java.lang.String\"}},{\"name\":\"pastWeekCount\",\"type\":\"long\"},{\"name\":\"pastWeekUniqueCount\",\"type\":\"long\"},{\"name\":\"pastMonthCount\",\"type\":\"long\"},{\"name\":\"pastMonthUniqueCount\",\"type\":\"long\"}]}");
   ...
   */
  public static job.model.Activity.Builder newBuilder() {
    return new job.model.Activity.Builder();
  }
   ...
   * @return A new Activity RecordBuilder
   */
  public static job.model.Activity.Builder newBuilder(job.model.Activity.Builder other) {
    return new job.model.Activity.Builder(other);
  }
   ...
   * @return A new Activity RecordBuilder
   */
  public static job.model.Activity.Builder newBuilder(job.model.Activity other) {
    return new job.model.Activity.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Activity>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(job.model.Activity.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(job.model.Activity other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventType)) {
        this.eventType = data().deepCopy(fields()[0].schema(), other.eventType);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder setEventType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder clearEventType() {
      eventType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder setPastWeekCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder clearPastWeekCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder setPastWeekUniqueCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder clearPastWeekUniqueCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder setPastMonthCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder clearPastMonthCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder setPastMonthUniqueCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public job.model.Activity.Builder clearPastMonthUniqueCount() {
