...
import job.other.model.Event;
import job.other.model.EventSubject;
import job.other.model.SimpleEvent;
import job.other.config.SampleOptions;
 ...
 */
public class SampleEventAggregator {
